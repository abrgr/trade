  ...
  (if (every? some? primary-sources)
    (let [tz utils/ny-time
      ...
      (if (= 0 remaining-count)
        (org.apache.commons.math3.distribution.NormalDistribution. 0.0 (/ std 10)) ; TODO: this isn't quite right - poisson of whether rcp actually updates + possibility of unknown surveys; at least this is better than constant dist
